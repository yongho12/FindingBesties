...
# lotus
  ...
  user1 =  User(name='demo', email='demo@example.com',  password='password', avatar='/static/images/friends.png')
  user2 = User(name='Krisna', email='krisna@example.com', password='password', avatar='/static/images/lotus.jpg')
  user3 = User(name='Matt R', email='mattr@example.com', password='password', avatar='/static/images/flower1.jpg')
  user4 = User(name='Andrea', email='andrea@example.com',  password='password', avatar='/static/images/friends.png')
  user5 = User(name='Andrew', email='andrew@example.com',  password='password', avatar='/static/images/lotus.jpg')
  user6 = User(name='Ben', email='ben@example.com',  password='password', avatar='/static/images/rose.jpg')
  user7 = User(name='Dan B', email='danb@example.com',  password='password', avatar='/static/images/flower1.jpg')
  user8 = User(name='Jony', email='jony@example.com',  password='password', avatar='/static/images/sunflower.jpg')
  user9 = User(name='Julie', email='julie@example.com',  password='password', avatar='/static/images/lotus.jpg')
  user10 = User(name='Erin', email='erin@example.com',  password='password', avatar='/static/images/flower1.jpg')

  user11 = User(name='Isaac', email='isaac@example.com',  password='password', avatar='/static/images/sunflower.jpg')
  user12 = User(name='Ivan', email='ivan@example.com', password='password', avatar='/static/images/sunflower.jpg')
  user13 = User(name='James', email='james@example.com', password='password', avatar='/static/images/lotus.jpg')
  user14 = User(name='Jaron', email='jaron@example.com',  password='password', avatar='/static/images/lotus.jpg')
  user15 = User(name='Jeff', email='jeff@example.com',  password='password', avatar='/static/images/friends.png')
  user16 = User(name='Michael', email='michael@example.com',  password='password', avatar='/static/images/lotus.jpg')
  user17 = User(name='John M', email='johnm@example.com',  password='password', avatar='/static/images/lotus.jpg')
  user18 = User(name='Daniel', email='daniel@example.com',  password='password', avatar='/static/images/sunflower.jpg')
  user19 = User(name='Dillon', email='dillon@example.com',  password='password', avatar='/static/images/flower1.jpg')
  user20 = User(name='Juliet', email='juliet@example.com',  password='password', avatar='/static/images/flower1.jpg')

  user21 = User(name='Kasey', email='kasey@example.com',  password='password', avatar='/static/images/sunflower.jpg')
  user22 = User(name='Alec', email='alec@example.com', password='password', avatar='/static/images/friends.png')
  user23 = User(name='Ammar', email='ammar@example.com', password='password', avatar='/static/images/friends.png')
  user24 = User(name='Matt Z', email='mattz@example.com',  password='password', avatar='/static/images/friends.png')
  user25 = User(name='Miah', email='miah@example.com',  password='password', avatar='/static/images/friends.png')
  user26 = User(name='John A', email='johna@example.com',  password='password', avatar='/static/images/daisy.jpg')
  user27 = User(name='Peter', email='peter@example.com',  password='password', avatar='/static/images/daisy.jpg')
  user28 = User(name='Quincy', email='quincy@example.com',  password='password', avatar='/static/images/friends.png')
  user29 = User(name='Javier', email='javier@example.com', password='password', avatar='/static/images/flower1.jpg')
  user30 = User(name='Sam', email='sam@example.com',  password='password', avatar='/static/images/rose.jpg')

  user31 = User(name='Sophie', email='sophie@example.com',  password='password', avatar='/static/images/lotus.jpg')
  user32 = User(name='Tyna', email='tyna@example.com', password='password', avatar='/static/images/flower1.jpg')
  user33 = User(name='Tom', email='tom@example.com', password='password', avatar='/static/images/rose.jpg')
  user34 = User(name='Corina', email='corina@example.com',  password='password', avatar='/static/images/flower1.jpg')
  user35 = User(name='Joanna', email='joanna@example.com',  password='password', avatar='/static/images/rose.jpg')
  user36 = User(name='Mylo', email='mylo@example.com',  password='password', avatar='/static/images/lotus.jpg')
  user37 = User(name='Geoffery', email='geoffery@example.com',  password='password', avatar='/static/images/lotus.jpg')
  user38 = User(name='Ian', email='ian@example.com',  password='password', avatar='/static/images/rose.jpg')
  user39 = User(name='Quynn', email='quynn@example.com',  password='password', avatar='/static/images/lotus.jpg')
  user40 = User(name='Dean', email='dean@example.com', password='password', avatar='/static/images/daisy.jpg')

  user41 = User(name='Angela', email='angela@example.com',  password='password', avatar='/static/images/daisy.jpg')
  user42 = User(name='Soon-Mi', email='soonmi@example.com',  password='password', avatar='/static/images/lotus.jpg')
  user43 = User(name='Alissa', email='alissa@example.com',  password='password', avatar='/static/images/daisy.jpg')
  user44 = User(name='Aaron', email='aaron@example.com',  password='password', avatar='/static/images/lotus.jpg')
  ...
  avartar1 = Avartarsample(avartar_file="/static/images/flower1.jpg")
  avartar2 = Avartarsample(avartar_file="/static/images/lotus.jpg")
  avartar3 = Avartarsample(avartar_file="/static/images/rose.jpg")
  avartar4 = Avartarsample(avartar_file="/static/images/sunflower.jpg")
  avartar5 = Avartarsample(avartar_file="/static/images/daisy.jpg")
  avartar6 = Avartarsample(avartar_file="/static/images/friends.png")
